...
[![Build and Publish](https://github.com/energypatrikhu/pterodactyl-minecraft-server/workflows/Build%20and%20Publish/badge.svg)](https://github.com/energypatrikhu/pterodactyl-minecraft-server/actions)
...
!!! note "More Compose Examples"
    There are more [examples located in the Github repo](https://github.com/energypatrikhu/pterodactyl-minecraft-server/tree/master/examples).
